        ...
        <div className="left-panel">
          <nav className="navigation">
            ...
            <div className="module-section">
              ...
              <ul>
                <li><Link to="/expense-analysis" className="normal-link">Expense Analysis</Link></li>
              </ul>
            </div>
            ...
            <div className="module-section">
              <h3>Legal Module</h3>
              <ul>
                <li><Link to="/legal" className="normal-link">Contract Analysis</Link></li>
                <li><Link to="/risk" className="normal-link">Risk Analysis</Link></li>
              </ul>
            </div>
            ...
            <div className="module-section">
              <ul>
                <li><Link to="/help-support" className="normal-link help-support-link">Support</Link></li>
              </ul>
            </div>
        ...
        <div className="right-panel">
          ...
          <div className="metrics-grid">
            <div className="metric-card">
              ...
              <p>4 <span className="growth-indicator">+4</span></p>
            </div>
            <div className="metric-card warning">
              <h3>Anomalies Detected</h3>
              <p>2 <span className="status-indicator">Attention Needed</span></p>
            </div>
            <div className="metric-card">
